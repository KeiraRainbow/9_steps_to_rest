...
define config.name = _("9 шагов к покою")
...
Данная визуальная новелла была создана в качестве дипломного проекта выпускницей славного колледжа электроники.

В игре была использована следующая музыка:

Неопознанный объект - "Панельная страна",
Неопознанный объект - "Капитуляция",
Трагикомедия - "Актеры и маски",
Трагикомедия - "Почему?",
и, конечно же, прекрасная мелодия для главного меню :)
""")
...
define config.save_directory = "diary-1650123954"
